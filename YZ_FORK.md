...
当前开发源码版本为 `v26.9.0`（可信转发机名单），起点为已被 YZboard-Node `v1.17.2` 至 `v1.20.0` 固定消费的 `v26.8.1` / `f242ad6931521c1d56245e3566dcf7bc11b9571c`。产品版本独立于 Xray 上游版本；历史版本保持原名。Go 模块消费者应固定到验证后的完整提交，不能仅使用这里的源码版本说明。
